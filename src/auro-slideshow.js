 ...
 * @slot ariaLabel.slide.prev - The aria-label for the button navigating to the previous slide. Default is "Previous slide".
 * @slot ariaLabel.slide.next - The aria-label for the button navigating to the next slide. Default is "Next slide".
...
export class AuroSlideshow extends LitElement {
  ...
  renderNavigationControls() {
    return html`
      <${this.buttonTag} 
        aria-label="${this.runtimeUtils.getSlotText(this, "ariaLabel.slide.prev") || "Previous slide"}" 
        class="scroll-prev"
        shape="circle"
        onDark
        size="lg"
      ...
      <${this.buttonTag} 
        aria-label="${this.runtimeUtils.getSlotText(this, "ariaLabel.slide.next") || "Next slide"}"
        class="scroll-next"
        shape="circle"
        onDark
        size="lg"
  ...
  render() {
    return html`
      ...
      <slot name="ariaLabel.slide.prev" hidden @slotchange="${this.requestUpdate}"></slot>
      <slot name="ariaLabel.slide.next" hidden @slotchange="${this.requestUpdate}"></slot>
